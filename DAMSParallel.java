...
public class DAMSParallel {
    ...
    private static WebDriver setupDriver() {
        // System.setProperty("webdriver.chrome.driver", "chromedriver.exe"); // <-- YEH LINE REMOVE KAR DI GAYI HAI
        
        ChromeOptions options = new ChromeOptions();
        options.addArguments("--remote-allow-origins=*");
        options.addArguments("--disable-blink-features=AutomationControlled");
        
        // --- YEH OPTIONS ADD KIYE GAYE HAIN GITHUB ACTIONS KE LIYE ---
        ...
        // options.addArguments("--start-maximized"); // Headless mode mein iski zaroorat nahi
